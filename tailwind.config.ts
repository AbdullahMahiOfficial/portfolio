	...
	theme: {
		...
		extend: {
			colors: {
				...
				cert: {
					orange: 'hsl(var(--cert-orange))',
					red: 'hsl(var(--cert-red))',
					blue: 'hsl(var(--cert-blue))',
					google: 'hsl(var(--cert-google))',
					microsoft: 'hsl(var(--cert-microsoft))',
					redhat: 'hsl(var(--cert-redhat))'
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
